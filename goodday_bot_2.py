...
WELCOME_TEXT = (
    "🎉 <b>GOOD DAY ПОЛОЦК уже совсем скоро.</b>\n\n"
...
PRIZES_CAPTION = (
    ...
    "🎁 Список призов постоянно обновляется в течение фестиваля.\n"
    ...
    "Standard, VIP и VIP Deluxe.\n\n"
    "⬇️ Узнать больше о возможностях браслетов"
)
...
QUEST_TEXT = (
    ...
    "партнёров и собирай фестивальную валюту.\n\n"
...
STANDART_TEXT = (
    ...
    "⭐️ VIP-зона Good Day с 12:00 до 19:00 + 📷 работа фотографа\n"
...
RAFFLE_TEXT = (
    ...
    "📱 Онлайн\n\n"
    "⏰ Приём заявок открыт до 23:00 27 июня\n\n"
    "🎤 А уже 27 июня в 23:00 на площадке GOOD DAY ПОЛОЦК (на сцене) состоится "
...
def main_menu_keyboard():
    return InlineKeyboardMarkup([
        ...
        [InlineKeyboardButton("🎁 Список призов", callback_data="prizes")],
...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # --- STANDART ---
        ...
        keyboard = InlineKeyboardMarkup([
            [InlineKeyboardButton("🟡 Quest", callback_data="b_quest")],
            [InlineKeyboardButton("🟢 VIP", callback_data="vip")],
            [InlineKeyboardButton("🟠 VIP DELUXE", callback_data="deluxe")],
            [InlineKeyboardButton("🔙 Главное меню", callback_data="menu")],
        ])
